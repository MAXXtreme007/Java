...
public interface ICircuit {
	...
	////**********Methods************
	/**
	 * Sets the voltage of the circuit using
	 * the amperage and resistance properties. 
	 */
	void calculateVoltage();

	/**
	 * Sets the amperage of the circuit using
	 * the voltage and resistance properties. 
	 */
	void calculateAmperage();
		
	/**
	 * Sets the resistance of the circuit using
	 * the voltage and amperage properties. 
	 */
